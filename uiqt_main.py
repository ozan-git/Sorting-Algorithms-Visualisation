...
"    background-color: qlineargradient(spread:pad, x1:0, y1:0.453136, x2:1, y2:0.523273, stop:0 rgba(104, 113, 138, 255), stop:1 rgba(215, 221, 232, 255));}")
        ...
        self.sort_button.setMaximumSize(QtCore.QSize(512, 256))
        font = QtGui.QFont()
...
"background-color: qlineargradient(spread:reflect, x1:0, y1:0.279, x2:1, y2:0.83, stop:0 rgba(26, 214, 24, 255), stop:1 rgba(68, 184, 255, 255));}")
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.binary_search_button.sizePolicy().hasHeightForWidth())
        self.binary_search_button.setSizePolicy(sizePolicy)
        self.binary_search_button.setMinimumSize(QtCore.QSize(256, 128))
        self.binary_search_button.setMaximumSize(QtCore.QSize(512, 256))
        font = QtGui.QFont()
        font.setFamily("Ubuntu")
        font.setPointSize(12)
        font.setBold(True)
...
"background-color: qlineargradient(spread:reflect, x1:0, y1:0.279, x2:1, y2:0.83, stop:0 rgba(26, 214, 24, 255), stop:1 rgba(68, 184, 255, 255));}")
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.fibonacci_button.sizePolicy().hasHeightForWidth())
        self.fibonacci_button.setSizePolicy(sizePolicy)
        self.fibonacci_button.setMinimumSize(QtCore.QSize(256, 128))
        self.fibonacci_button.setMaximumSize(QtCore.QSize(512, 256))
        font = QtGui.QFont()
        font.setFamily("Ubuntu")
        font.setPointSize(12)
        font.setBold(True)
...
"background-color: qlineargradient(spread:reflect, x1:0, y1:0.279, x2:1, y2:0.83, stop:0 rgba(26, 214, 24, 255), stop:1 rgba(68, 184, 255, 255));}")
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.timecomp_button.sizePolicy().hasHeightForWidth())
        self.timecomp_button.setSizePolicy(sizePolicy)
        self.timecomp_button.setMinimumSize(QtCore.QSize(256, 128))
        self.timecomp_button.setMaximumSize(QtCore.QSize(512, 256))
        font = QtGui.QFont()
        font.setFamily("Ubuntu")
        font.setPointSize(12)
        font.setBold(True)
...
"background-color: qlineargradient(spread:reflect, x1:0, y1:0.279, x2:1, y2:0.83, stop:0 rgba(26, 214, 24, 255), stop:1 rgba(68, 184, 255, 255));}")
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.matrix_button.sizePolicy().hasHeightForWidth())
        self.matrix_button.setSizePolicy(sizePolicy)
        self.matrix_button.setMinimumSize(QtCore.QSize(256, 128))
        self.matrix_button.setMaximumSize(QtCore.QSize(512, 256))
        font = QtGui.QFont()
        font.setFamily("Ubuntu")
        font.setPointSize(12)
        font.setBold(True)
...
"background-color: qlineargradient(spread:reflect, x1:0, y1:0.279, x2:1, y2:0.83, stop:0 rgba(26, 214, 24, 255), stop:1 rgba(68, 184, 255, 255));}")
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.kthsmallest_button.sizePolicy().hasHeightForWidth())
        self.kthsmallest_button.setSizePolicy(sizePolicy)
        self.kthsmallest_button.setMinimumSize(QtCore.QSize(256, 128))
        self.kthsmallest_button.setMaximumSize(QtCore.QSize(512, 256))
        font = QtGui.QFont()
        font.setFamily("Ubuntu")
        font.setPointSize(12)
        font.setBold(True)
...
"")
        ...
        self.verticalLayout_2.addWidget(self.size_grip)
